            ...
            <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
              <div class="is-scrollbar-hidden grow overflow-y-auto">
                ...
                <ul class="mt-5 space-y-1.5 px-2 font-inter text-xs+ font-medium">
                  <li>
                    <a class="group flex space-x-2 rounded-lg p-2 tracking-wide outline-none transition-all <?= ($current_page == 'prices.php') ? 'bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light' : 'text-slate-800 hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600' ?>" href="analytics.php">
                       <svg xmlns="http://www.w3.org/2000/svg" class="size-4.5 <?= ($current_page == 'prices.php') ? 'text-primary dark:text-accent-light' : 'text-slate-400' ?> transition-colors group-hover:text-slate-500" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
