...
<aside class="w-56 bg-white border-r border-gray-100 flex flex-col flex-shrink-0 overflow-y-auto scrollbar-hide">
    ...
    <nav class="flex-1 px-2 py-3 space-y-0.5">
        ...
        $nav = [
            ...
            'Training' => [
                ['training.php',          'Courses',          '<rect x="2" y="3" width="11" height="8" rx="1"/><path d="M5 11v2M10 11v2M3 13h9"/>'],
                ['training_progress.php', 'Farmer progress',  '<circle cx="7.5" cy="7.5" r="5.5"/><path d="M7.5 4.5v3l2 1.5"/>'],
            ],
            'Field work' => [
