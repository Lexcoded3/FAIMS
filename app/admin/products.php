        ...
        <div class="mt-5 grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
          <div class="col-span-12 sm:col-span-6 lg:col-span-8">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="mt-4 grid grid-cols-2 gap-4 sm:mt-5 sm:grid-cols-2 sm:gap-5 lg:mt-6 lg:grid-cols-3 xl:grid-cols-4" id="productsContainer">
                <?php include 'products_table_partial.php';?>
              ...
              <div class="card p-2">
                ...
                <div class="mt-4 flex items-center justify-between">
                  <div class="flex space-x-2">
                      ...
                      <button class="btn size-7 rounded-full bg-error/10 p-0 text-error hover:bg-error/20 focus:bg-error/20 active:bg-error/25" x-tooltip.error="'Delete'">
          ...
          <div class="hidden sm:col-span-6 sm:block lg:col-span-4">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-1">
                <p>
                  <span class="text-base font-medium text-slate-700 dark:text-navy-100">Latest Uploads</span>
                  <span></span>
                </p>
