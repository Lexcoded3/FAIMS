                ...
                <div class="flex items-center justify-between gap-4">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <?php if (!empty($search) || !empty($status_filter)): ?>
                      <a href="orders.php" class="btn rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 dark:border-navy-500 dark:bg-navy-700 dark:text-slate-300">
                ...
                <table class="w-full text-left">
                  <thead>
                    <tr class="border-b border-slate-200 dark:border-navy-500">
                      <th class="whitespace-nowrap bg-slate-100 px-4 py-3 font-semibold text-slate-700 dark:bg-navy-700 dark:text-slate-300 sm:px-5">Order ID</th>
                      <th class="whitespace-nowrap bg-slate-100 px-4 py-3 font-semibold text-slate-700 dark:bg-navy-700 dark:text-slate-300 sm:px-5">Date</th>
                      <th class="whitespace-nowrap bg-slate-100 px-4 py-3 font-semibold text-slate-700 dark:bg-navy-700 dark:text-slate-300 sm:px-5">Customer</th>
                      <th class="whitespace-nowrap bg-slate-100 px-4 py-3 font-semibold text-slate-700 dark:bg-navy-700 dark:text-slate-300 sm:px-5">Status</th>
                      <th class="whitespace-nowrap bg-slate-100 px-4 py-3 font-semibold text-slate-700 dark:bg-navy-700 dark:text-slate-300 sm:px-5">Amount</th>
                      <th class="whitespace-nowrap bg-slate-100 px-4 py-3 font-semibold text-slate-700 dark:bg-navy-700 dark:text-slate-300 sm:px-5">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      <?php while ($row = $orderQuery->fetch_assoc()): ?>
                        <tr class="border-b border-slate-100 hover:bg-slate-50 dark:border-navy-600 dark:hover:bg-navy-700/50">
                          ...
                          <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <?php 
                              $status = $row['status'];
                              $status_color = $status === 'completed' ? 'emerald' : ($status === 'pending' ? 'warning' : 'error');
                              $status_text = ucfirst($status);
                            ?>
                            <span class="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium bg-<?php echo $status_color; ?>-100 text-<?php echo $status_color; ?>-700 dark:bg-<?php echo $status_color; ?>-900/30 dark:text-<?php echo $status_color; ?>-300">
                          ...
                          <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div x-data="{ showModal: false, orderId: <?php echo $row['id']; ?> }" class="flex gap-2">
                              <button @click="showModal = true" class="btn rounded-lg bg-primary px-3 py-1.5 text-xs font-medium text-white hover:bg-primary-focus dark:bg-accent dark:hover:bg-accent-focus">
                                <i class="fa-solid fa-eye"></i>
                              </button>

                              <?php if ($row['status'] === 'pending'): ?>
                                <a href="complete_order.php?id=<?php echo $row['id']; ?>" class="btn rounded-lg bg-emerald-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-emerald-700">
