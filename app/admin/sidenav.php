...
<div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
   ...
   x-tooltip.placement.right="'Dashboards'">
              ...
              <a href="users.php" 
                 ...
                 <?= in_array($current_page, ['users.php', 'adduser.php', 'roles.php', 'invitation.php', 'groups.php', 'activity_logs.php', 'group_members.php']) 
                    ? 'bg-primary/10 text-primary dark:bg-navy-600 dark:text-accent-light'
                    : 'hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25' ?>"
   ...
   <?= $current_page == 'products.php' 
      ? 'bg-primary/10 text-primary dark:bg-navy-600 dark:text-accent-light'
      : 'hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25' ?>"
   x-tooltip.placement.right="'Products & Crops'">
   ...
   <?= in_array($current_page, ['training.php', 'lesson_view.php','courses.php']) 
      ? 'bg-primary/10 text-primary dark:bg-navy-600 dark:text-accent-light'
      : 'hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25' ?>"
   x-tooltip.placement.right="'Training'">
              ...
              <!-- Reports -->
              <a href="extension_reports.php" 
                 class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200
                 <?= in_array($current_page, ['extension_reports.php']) 
                    ? 'bg-primary/10 text-primary dark:bg-navy-600 dark:text-accent-light'
                    : 'hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25' ?>" x-tooltip.placement.right="'Reports'">
   ...
   <?= in_array($current_page, ['../forum/index.php'])
      ? 'bg-primary/10 text-primary dark:bg-navy-600 dark:text-accent-light'
      : 'hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25' ?>"
